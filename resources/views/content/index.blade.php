...
@section('content')
    ...
    <div class="mb-2">
        <a href="{{ url('logout') }}" role="button" class="btn btn-sm btn-warning custom-left-aligned">Logout</a>
    </div>
    <br>
    <div class="mb-2">
        <a href="{{ url('content/create') }}" role="button" class="btn btn-sm btn-success">Create Content</a>
        <a href="{{ url('content/create') }}" role="button" class="btn btn-sm btn-info">Main Menu</a>
    </div>
